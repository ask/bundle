...
if sys.version_info < (2, 4):
    raise Exception("Bundle requires Python 2.4 or higher.")
...
meta_fh = open(os.path.join(here, "bundle/__init__.py"))
try:
    meta = {}
    for line in meta_fh:
...
if os.path.exists("README.rst"):
    ...
    long_description = "See http://pypi.python.org/pypi/bundle"
